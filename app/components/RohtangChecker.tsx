      ...
      <style>{`
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box }
        ...
        @media(max-width:600px) {
          ...
          .page { padding-top:130px; padding-bottom:40px }
          ...
          <div className="answer-wrap">
            <div className={`answer-inner${showAnswer ? ' show' : ''}`}>
              ...
              <div className="related-reads">
                <Link href="/blog/rohtang-pass-opening-date-season">When does it open each year?</Link>
                <Link href="/blog/what-actually-closes-rohtang-pass">What actually closes it</Link>
              </div>
            </div>
          </div>
        </div>
